...
const Header = () => {
    ...
    const toggleView = () => {
        document.getElementById('formBox').classList.toggle('-translate-x-72');
    }
                    ...
                    <>
                        <div className="flex justify-between py-3 px-7 md:px-24 bg-neutral-900">
                            ...
                            <div className="my-auto">
                                <button id="loginButton" onClick={toggleView} className="text-white text-xl p-2 hover:bg-neutral-800 rounded-lg border border-neutral-900 hover:border-neutral-700">Log in</button>
                            </div>
                        </div>
                        <div id="formBox" className="fixed -right-72 duration-500 top-28 rounded-l-lg bg-neutral-900 h-fit">
