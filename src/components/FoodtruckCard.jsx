...
const FoodtruckCard = () => {
    ...
    return (
        <div className="flex lg:w-[30%] justify-center">
            <div className="w-[60%] shrink-0 p-5 text-right font-light  border-r border-neutral-600 my-8 rounded-l-md bg-neutral-900 text-neutral-200 text-md">
                Foodtruck evenement: Maandelijks nieuwe ontdekkingen met inspiraties en smaken van over onze wonderlijke wereld.
            </div>
            <div className="flex flex-col p-5  font-serif my-8 rounded-r-md bg-neutral-900 text-neutral-200 text-3xl">
                <div>Foodtruck</div>
                ...
                modalEnabled ?
                    <div className="z-10 grid place-items-center fixed h-screen w-screen top-0 left-0 bg-black/[.75]">
                        <div className="container rounded-xl border bg-neutral-200 flex flex-col w-fit">
                            <div className="text-neutral-200 rounded-t-xl font-serif font-bold underline text-4xl border-b-2 py-4 px-5 bg-neutral-900">FOODTRUCK</div>
