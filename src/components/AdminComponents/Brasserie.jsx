...
import { BrasserieContext } from "../../contexts/BrasserieProvider";

const Brasserie = () => {
    const { brasserieOpeningsuren, getAllOpeningsuren, updateOpeningsuur } = useContext(BrasserieContext);
                ...
                <form onSubmit={handleSubmit(onSubmit)} id="form">
                    {
                        !view ?
                            <>
                                <div onClick={() => toggleView(!view)} className="mx-auto rounded-t-lg text-neutral-100 px-2 py-1 bg-neutral-900 hover:underline hover:cursor-pointer w-fit">Brasserie openingsuren instellen</div>
                                <div className="flex flex-col gap-y-4 border rounded-xl border-neutral-900 divide-neutral-900 p-6 mx-auto w-fit">
                                    {
                                        brasserieOpeningsuren.map((openingsuur) => (
                                            <div key={openingsuur.brasserieID} className="grid grid-cols-2 gap-14">
